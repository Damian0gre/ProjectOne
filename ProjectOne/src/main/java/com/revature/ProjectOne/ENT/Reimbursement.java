package com.revature.ProjectOne.ENT;
...
public class Reimbursement {
	...
	public Reimbursement(int rid, float amount, String submit_date, int status, String status_date,
			String employee_note, String manager_note, int cid, int eid) {
		this.rid = rid;
		this.amount = amount;
	...
	public String toString() {
		return "Reimbursement{" + "rid=" + rid + ", amount=" + amount + ", submit_date=" + submit_date + ", status="
				+ status + ", status_date=" + status_date + ", employee_note='" + employee_note + '\''
				+ ", manager_note='" + manager_note + '\'' + ", cid=" + cid + ", eid=" + eid + '}';
	}
}
