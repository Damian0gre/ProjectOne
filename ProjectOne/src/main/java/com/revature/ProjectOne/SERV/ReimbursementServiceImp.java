...
import com.revature.ProjectOne.DAO.ReimbursementDAOImp;
...
//    private  ReimbursementDAO rdao ;
	...
	public List<Reimbursement> getReimbursementsStatusDateAscending() {
		List<Reimbursement> filterMe = rserv.getAllReimbursement();
		Collections.sort(filterMe, (r1, r2) -> String.CASE_INSENSITIVE_ORDER.compare(r1.getStatus_date().toString(),
				r2.getStatus_date().toString()));
	...
	public List<Reimbursement> getReimbursementsSubmitDateAscending() {
		List<Reimbursement> filterMe = rserv.getAllReimbursement();
		Collections.sort(filterMe, (r1, r2) -> String.CASE_INSENSITIVE_ORDER.compare(r1.getSubmit_date().toString(),
				r2.getSubmit_date().toString()));
		Collections.reverse(filterMe);
		return filterMe;
	}
