package com.revature.ProjectOne.UTILS;
...
public class HibernateUtil {
	...
	// the SessionFactory Interface is resposbile for making the intitial database
	// connection and setting up the mappings between the entity and the table
